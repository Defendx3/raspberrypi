...
default_args = {
  ...
  'mqtt_broker' : 'dc0c2bce573048948476ce00848243d4.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-f2d7", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_cybersecuritywithprivategpt-f2d7"], schedule=None,catchup=False)
